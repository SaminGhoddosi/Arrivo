...
{
    public class TicketBuildingSpecification : Specification<Ticket, TicketAppModel>
    {
        public TicketBuildingSpecification(int id)
        {
            Query.Where(x => x.Resident.Apartment.BuildingId == id)
